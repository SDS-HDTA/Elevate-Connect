...
public interface IProjectService {
    ...
    PageResult<Project> getPaginatedListOfAllProjects(Integer page, Integer size, Integer searchType, String searchValue);
    ProjectResponse getProjectById(Integer projectId);
    List<Project> searchMyProjects(Integer userId, Integer searchType, String searchValue);
