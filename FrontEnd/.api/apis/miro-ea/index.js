...
class SDK {
    constructor() {
        ...
        this.core = new APICore(this.spec, 'miro-ea/v2.0 (api/6.1.3)');
    }
    /**
     ...
     */
    createBoard(body) {
        return this.core.fetch('/v2/boards', 'post', body);
    }
    /**
     ...
     */
    getBoards(metadata) {
        return this.core.fetch('/v2/boards', 'get', metadata);
    }
    copyBoard(body, metadata) {
        return this.core.fetch('/v2/boards', 'put', body, metadata);
    }
    /**
     ...
     */
    getSpecificBoard(metadata) {
        return this.core.fetch('/v2/boards/{board_id}', 'get', metadata);
    }
    /**
     ...
     */
    updateBoard(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}', 'patch', body, metadata);
    }
    /**
     ...
     */
    deleteBoard(metadata) {
        return this.core.fetch('/v2/boards/{board_id}', 'delete', metadata);
    }
    /**
     ...
     */
    createAppCardItem(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/app_cards', 'post', body, metadata);
    }
    /**
     ...
     */
    getAppCardItem(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/app_cards/{item_id}', 'get', metadata);
    }
    /**
     ...
     */
    updateAppCardItem(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/app_cards/{item_id}', 'patch', body, metadata);
    }
    /**
     ...
     */
    deleteAppCardItem(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/app_cards/{item_id}', 'delete', metadata);
    }
    /**
     ...
     */
    createCardItem(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/cards', 'post', body, metadata);
    }
    /**
     ...
     */
    getCardItem(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/cards/{item_id}', 'get', metadata);
    }
    /**
     ...
     */
    updateCardItem(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/cards/{item_id}', 'patch', body, metadata);
    }
    /**
     ...
     */
    deleteCardItem(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/cards/{item_id}', 'delete', metadata);
    }
    /**
     ...
     */
    createConnector(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/connectors', 'post', body, metadata);
    }
    /**
     ...
     */
    getConnectors(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/connectors', 'get', metadata);
    }
    /**
     ...
     */
    getConnector(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/connectors/{connector_id}', 'get', metadata);
    }
    /**
     ...
     */
    updateConnector(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/connectors/{connector_id}', 'patch', body, metadata);
    }
    /**
     ...
     */
    deleteConnector(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/connectors/{connector_id}', 'delete', metadata);
    }
    /**
     ...
     */
    createDocumentItemUsingUrl(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/documents', 'post', body, metadata);
    }
    /**
     ...
     */
    getDocumentItem(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/documents/{item_id}', 'get', metadata);
    }
    /**
     ...
     */
    updateDocumentItemUsingUrl(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/documents/{item_id}', 'patch', body, metadata);
    }
    /**
     ...
     */
    deleteDocumentItem(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/documents/{item_id}', 'delete', metadata);
    }
    /**
     ...
     */
    createEmbedItem(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/embeds', 'post', body, metadata);
    }
    /**
     ...
     */
    getEmbedItem(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/embeds/{item_id}', 'get', metadata);
    }
    /**
     ...
     */
    updateEmbedItem(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/embeds/{item_id}', 'patch', body, metadata);
    }
    /**
     ...
     */
    deleteEmbedItem(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/embeds/{item_id}', 'delete', metadata);
    }
    /**
     ...
     */
    createImageItemUsingUrl(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/images', 'post', body, metadata);
    }
    /**
     ...
     */
    getImageItem(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/images/{item_id}', 'get', metadata);
    }
    /**
     ...
     */
    updateImageItemUsingUrl(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/images/{item_id}', 'patch', body, metadata);
    }
    /**
     ...
     */
    deleteImageItem(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/images/{item_id}', 'delete', metadata);
    }
    /**
     ...
     */
    getItems(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/items', 'get', metadata);
    }
    /**
     ...
     */
    getSpecificItem(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/items/{item_id}', 'get', metadata);
    }
    /**
     ...
     */
    updateItemPositionOrParent(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/items/{item_id}', 'patch', body, metadata);
    }
    /**
     ...
     */
    deleteItem(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/items/{item_id}', 'delete', metadata);
    }
    /**
     ...
     */
    shareBoard(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/members', 'post', body, metadata);
    }
    /**
     ...
     */
    getBoardMembers(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/members', 'get', metadata);
    }
    /**
     ...
     */
    getSpecificBoardMember(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/members/{board_member_id}', 'get', metadata);
    }
    /**
     ...
     */
    updateBoardMember(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/members/{board_member_id}', 'patch', body, metadata);
    }
    /**
     ...
     */
    removeBoardMember(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/members/{board_member_id}', 'delete', metadata);
    }
    /**
     ...
     */
    createShapeItem(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/shapes', 'post', body, metadata);
    }
    /**
     ...
     */
    getShapeItem(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/shapes/{item_id}', 'get', metadata);
    }
    /**
     ...
     */
    updateShapeItem(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/shapes/{item_id}', 'patch', body, metadata);
    }
    /**
     ...
     */
    deleteShapeItem(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/shapes/{item_id}', 'delete', metadata);
    }
    /**
     ...
     */
    createStickyNoteItem(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/sticky_notes', 'post', body, metadata);
    }
    /**
     ...
     */
    getStickyNoteItem(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/sticky_notes/{item_id}', 'get', metadata);
    }
    /**
     ...
     */
    updateStickyNoteItem(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/sticky_notes/{item_id}', 'patch', body, metadata);
    }
    /**
     ...
     */
    deleteStickyNoteItem(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/sticky_notes/{item_id}', 'delete', metadata);
    }
    /**
     ...
     */
    createTextItem(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/texts', 'post', body, metadata);
    }
    /**
     ...
     */
    getTextItem(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/texts/{item_id}', 'get', metadata);
    }
    /**
     ...
     */
    updateTextItem(body, metadata) {
        return this.core.fetch('/v2/boards/{board_id}/texts/{item_id}', 'patch', body, metadata);
    }
    /**
     ...
     */
    deleteTextItem(metadata) {
        return this.core.fetch('/v2/boards/{board_id}/texts/{item_id}', 'delete', metadata);
    }
}
